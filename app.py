...
if all_data:
    ...
    if st.session_state.menu == 'Dados':
        ...
        clubes_bloco = sorted(df_equipes['Equipe'].dropna().astype(str).unique().tolist())
        ...
        if 'Bilhetes' in all_data:
            ...
            if bilhetes_list:
                ...
                b3.metric('Meio-Red', meio_red_b)
                b4.metric('Devolvidas', devolvidas_b)
                b5.metric('Cashouts', cashouts_b)
